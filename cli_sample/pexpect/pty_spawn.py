...
class spawn(SpawnBase):
    ...
    def __init__(
        ...
        Remember that Pexpect does NOT interpret shell_sample meta characters such as
        redirect, pipe, or wild cards (``>``, ``|``, or ``*``). This is a
        common mistake.  If you want to run a command and pipe it through
        another command then you must also start a shell_sample. For example::
    ...
    def send(self, s):
        ...
        a shell_sample, then stty(1), before executing the final program::
