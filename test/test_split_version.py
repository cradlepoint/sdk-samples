...
class TestSplitVersion(unittest.TestCase):
        ...
        for test in tests:
            ...
            if expect_major == TypeError:
                ...
                if source_default is None:
                    major, minor = split_version_string(source)
                else:
                    major, minor = split_version_string(source, source_default)
    ...
    def test_split_version_dict(self):
        ...
        :return:
        """
        from cp_lib.split_version import split_version_save_to_dict, SETS_NAME_MAJOR, SETS_NAME_MINOR
