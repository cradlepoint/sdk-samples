...
- Connect the IBR1700 to the OBD port on a car or use an OBD-II simulator
- Enable OBD-II and PIDs in the IBR1700: System > Administration > OBD-II

## Expected Output

Logs will be generated based on the PID update interval showing the PID name along with the associated data:
